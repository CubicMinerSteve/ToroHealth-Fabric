...
public class DamageParticle extends Particle {
	...
	public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
		...
		Immediate vertexConsumerProvider = VertexConsumerProvider.immediate(new BufferAllocator(1536));

		textRenderer.draw(s, 0, 0, textColor, false, matrix, vertexConsumerProvider, TextLayerType.NORMAL, 0, 15728880,
				textRenderer.isRightToLeft());

		// Remember to release the buffer after building.
