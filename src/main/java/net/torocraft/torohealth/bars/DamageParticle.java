...
public class DamageParticle extends Particle {
	...
	public DamageParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
	...
	public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
		...
		textRenderer.draw(s, 0F, 0F, textColor, false, matrix, vertexConsumerProvider, false, 0, 15728880, textRenderer.isRightToLeft());
