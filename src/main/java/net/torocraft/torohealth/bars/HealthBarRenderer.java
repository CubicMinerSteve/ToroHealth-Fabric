...
public class HealthBarRenderer {
	...
	private static final Identifier GUI_BARS_TEXTURES = new Identifier(ToroHealth.MOD_ID + ":textures/gui/bars.png");
	...
	public static void renderInWorld(Matrix4f positionMatrix, Camera camera) {
		...
		for (LivingEntity entity : renderedEntities) {
			...
			renderWorldHealthBar(matrix4f, entity, 0, 0, FULL_SIZE, true);
		}

		renderedEntities.clear();
	}

	public static void renderWorldHealthBar(Matrix4f m4f, LivingEntity entity, double x, double y, float width,
			boolean inWorld) {
	...
	public static void renderHudHealthBar(DrawContext drawContext, LivingEntity entity, double x, double y,
		...
		Matrix4f m4f = drawContext.getMatrices().peek().getPositionMatrix(); // .getModel();
		drawBar(m4f, x, y, width, 1, DARK_GRAY, zOffset++, false);
		drawBar(m4f, x, y, width, percent2, color2, zOffset++, false);
		drawBar(m4f, x, y, width, percent, color, zOffset, false);
