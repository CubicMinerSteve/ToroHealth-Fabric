...
public class HealthBarRenderer {
	...
	public static void renderInWorld(MatrixStack matrix, Camera camera) {
		...
		for (LivingEntity entity : renderedEntities) {
			...
			renderWorldHealthBar(matrix, entity, 0, 0, FULL_SIZE, true);
		}

		renderedEntities.clear();
	}

	public static void renderWorldHealthBar(MatrixStack matrix, LivingEntity entity, double x, double y, float width,
			boolean inWorld) {
	...
	public static void renderHudHealthBar(DrawContext drawContext, LivingEntity entity, double x, double y, float width,
			boolean inWorld) {
