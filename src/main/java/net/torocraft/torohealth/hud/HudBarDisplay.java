...
public class HudBarDisplay {
	...
	private static final Identifier HEART_CONTAINER = Identifier.of("textures/gui/sprites/hud/heart/container.png");
	private static final Identifier HEART_FULL = Identifier.of("textures/gui/sprites/hud/heart/full.png");
	private static final Identifier ARMOR_FULL = Identifier.of("textures/gui/sprites/hud/armor_full.png");
	...
	public void draw(DrawContext drawContext, LivingEntity entity) {
		...
		HealthBarRenderer.renderwithDrawContext(drawContext, entity, 63, 14, 130, false);
